...
const ModalInscription = ({ show, onClose }) => {
  ...
  useEffect(() => {
    const getInscriptionPasswordListe = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BACK_URL}/InscriptionPassword`
        );
    ...
    const getIndex = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BACK_URL}/IndexInscriptionPassword`
        );
  ...
  const putIndex = async () => {
    try {
      ...
      const response = await axios.put(
        `${process.env.REACT_APP_BACK_URL}/IndexInscriptionPassword/${newValue}`
      );
